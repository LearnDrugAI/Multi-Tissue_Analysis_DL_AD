...
class AD_MIF(nn.Module):
    def __init__(self, ae1, ae2, gae1, gae2, n_node=None):
        super(AD_MIF, self).__init__()
        ...
        self.outlayer = nn.Linear(40,opt.args.n_clusters)
    ...
    def forward(self, x1, adj1, x2, adj2,pretrain=False):
        ...
        output = self.outlayer(z_combined)
        ...
        return x_hat1, z_hat1, a_hat1, x_hat2, z_hat2, a_hat2, Q1, Q2, z1, z2, cons,output
